...
namespace Validation1
{
    public partial class DropDown : System.Web.UI.Page
    {
        ...
        {
            string connectionString = "Data Source=using System;
using System.Collections.Generic;
            using System.Linq;
            using System.Web;
            using System.Data.SqlClient;
...
namespace Validation1
    {
        public partial class DropDown : System.Web.UI.Page
        {
            ...
            protected void GetItem(string ProductName)
            {
                string connectionString = "Data Source=LAPTOP-K6ENR28R; initial catalog=master;integrated security = true;";
                SqlConnection con = new SqlConnection(connectionString);
                SqlCommand command = new SqlCommand("GetIceCreamProducts1", con);
