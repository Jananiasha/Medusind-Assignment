<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Validation.aspx.cs" Inherits="validation1.Validation" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtname" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            Family Name :&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox1" runat="server" BackColor="#D19FE8"></asp:TextBox>
            <asp:TextBox ID="Txtfamname" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            Address :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtaddress" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            City :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtcity" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            Zip Code :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtzip" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            Phone No :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtnum" runat="server" BackColor="#D19FE8"></asp:TextBox>
        ...
        <p>
            Email :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Txtemail" runat="server" BackColor="#D19FE8"></asp:TextBox>
